...
*/
  ...
  <script>
    ...
    function upvoteCommentFunction(id)
    {
        ...
        ajaxRequest.open("GET", "ajax_upvote_comment.php?com="+id, true);
        ajaxRequest.send();
    }
    ...
    function upvoteIdeaFunction(id)
    {
        ...
        ajaxRequest.open("GET", "ajax_upvote_idea.php?id="+id, true);
        ajaxRequest.send();
    }
    ...
    function registerInterestFunction(id)
    {
        ...
        ajaxRequest.open("GET", "ajax_register_interest.php?id="+id, true);
        ajaxRequest.send();
    }
