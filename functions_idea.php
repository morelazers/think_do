...
{
    echo '<div id="form_idea"><form method="post" name="ideaForm" action="'; echo $PHP_SELF; echo '">
	...
	echo '<br><input type="submit" name="submit" class="normalButton" value="Submit"></form></div></div></div>';
}
